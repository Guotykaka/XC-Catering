		...
		<view class="page-body">
			<view class="wrapper">
				...
				<view class="editor-wrapper">
					<editor id="editor" class="ql-container" placeholder="开始输入..." showImgSize showImgToolbar showImgResize @statuschange="onStatusChange" :read-only="readOnly" @ready="onEditorReady"> </editor>
					<view @tap="com">666666</view>
				</view>
			</view>
		</view>
	</view>
	...
	methods: {
		com() {
			this.editorCtx.getContents({
				success(res){
                    console.log("🚀 ~ file: editor.vue ~ line 64 ~ success ~ res", res)
				}
			})
		},
		readOnlyChange() {
